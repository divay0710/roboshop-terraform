...
module "docdb" {
  source = "git::https://github.com/divay0710/tf-module-docdb.git"
...
module "rds" {
  source = "git::https://github.com/divay0710/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/divay0710/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/divay0710/tf-module-amazon-mq.git"
...
module "alb" {
  source = "git::https://github.com/divay0710/tf-module-alb.git"
